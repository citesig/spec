...
| ---------- | ------------------------------------------------------------------- | ------------------------------ | ------- | ----------- |
| JavaScript | [`@citesig/core`](https://www.npmjs.com/package/@citesig/core)      | `npm install @citesig/core`    | 0.1.0   | 8/8 vectors |
| Python     | [`citesig`](https://pypi.org/project/citesig/)                      | `pip install citesig`          | 0.1.0   | 8/8 vectors |
